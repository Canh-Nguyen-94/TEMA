...
<template>
  <div>
      ...
      <div class="flex flex-wrap md:flex-nowrap h-100vh bg-foreground">
        ...
        <div class="relative">
          <img
            ...
            class="md:w-[50vw] h-full object-cover"
          />
          <img
          ...
          <img
            ...
            class="absolute w-[100px] md:w-[195px] -bottom-[5%] -bottom-[100px] right-10 z-20"
          />
        </div>
      </div>
      <div
          ...
          <div class="flex flex-col md:flex-row items-center gap-4">
            ...
            >
              ...
              <p class="text-center md:text-left px-20 md:px-0">
                Browse hundreds of in-depth videos, courses, and guides to get
                up and running fast
              </p>
            </div>
            <div
    ...
    <CircleChevronUp
      ref="appButton"
      id="appButton"
      class="fixed bottom-20 right-10 text-accent bg-muted rounded-[50%] cursor-pointer"
      @click="scrollToTop"
    />
  </div>
</template>
